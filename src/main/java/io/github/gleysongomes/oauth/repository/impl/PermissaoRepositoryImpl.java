...
public class PermissaoRepositoryImpl implements PermissaoRepositoryCustom {
	...
	public List<PermissaoResumoMapping> findPermissoesGrupoByCdUsuarioAndNomesApis(Long cdUsuario, String nomesApis) {
		...
		String sql = "SELECT P.\"CD_PERMISSAO\", " + 
				"		P.\"NOME\" " + 
				"FROM \"OAUTH\".\"TB_PERMISSAO\" P, " + 
				"	\"OAUTH\".\"TB_APLICACAO\" A," + 
				"	\"OAUTH\".\"TB_GRUPO\" G," + 
				"	\"OAUTH\".\"TB_USUARIO\" U, " + 
				"	\"OAUTH\".\"TB_PERMISSAO_GRUPO\" PG, " + 
				"	\"OAUTH\".\"TB_GRUPO_USUARIO\" GU " + 
				"WHERE P.\"CD_APLICACAO\" = A.\"CD_APLICACAO\" " + 
				"AND P.\"CD_PERMISSAO\" = PG.\"CD_PERMISSAO\" " + 
				...
				"AND A.\"NOME\" IN (:nomesApis) " + 
				"ORDER BY P.\"CD_PERMISSAO\" ";
		// @formatter:on

		Query query = entityManager.createNativeQuery(sql, PermissaoResumoMapping.class).setParameter("cdUsuario", cdUsuario)
				.setParameter("nomesApis", nomesApis);
